...
signed main() {
    ...
    for(char c:s) {
        ...
        elif(val>=65 && val<=90) up++;
        else sy++;
    }

    cout << fixed << setprecision(16) <<  wh/(int)s.size() << '\n';
    cout << fixed << setprecision(16) << lo/(int)s.size() << '\n';
    cout << fixed << setprecision(16) << up/(int)s.size() << '\n';
    cout << fixed << setprecision(16) << sy/(int)s.size() << '\n';
}